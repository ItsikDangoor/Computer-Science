...
let transformed = array.map(double);
log(transformed);
...
let transformed2 = array.map(square);
log(transformed2);


//-------------------------------------------------------------
//Test 3
function doubleAndSquareEach(toDoubleNSquare) {
    toDoubleNSquare = double(toDoubleNSquare);
    return square(toDoubleNSquare);
}

let transformed3 = array.map(doubleAndSquareEach);
log(transformed3);
